...
--
-- Table structure for table `person_coins`
--

DROP TABLE IF EXISTS `person_coins`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
CREATE TABLE `person_coins` (
  `person_id` int(11) NOT NULL,
  `app_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `ignorelists`;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
...
CREATE TABLE `payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `callbackUrl` char(128) DEFAULT NULL,
...
--  `itemName` char(128) DEFAULT NULL,
--  `imageUrl` char(128) DEFAULT NULL,
